...
public class JobHistoryPrimary extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        job_ended = findViewById(R.id.endedbtnH);
        job_ended.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toSecondary = new Intent(JobHistoryPrimary.this,JobHistoryEnded.class);
    ...
    public void generatePostList(String parentname, String childname, String childlevel, String childedulevel, String location, String address, String subject, String date) {
        ...
        LinearLayout mainLayout = findViewById(R.id.jobHistoryLL);
        ...
        contactbtn.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent toMessage = new Intent(JobHistoryPrimary.this,MessageContentTutor.class);
